...
def add_platoons(plexe,step):
    ...
    print(grouped_lanes,TRAFFIC_DENSITY)
    for i in range(len(grouped_lanes)):
...
def main():
    directory = "/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/three_way"
...
if __name__ == "__main__":
    ...
    conflict_matrix = {}
    df = pd.read_csv("/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/three_way/harmony.csv")
    for i in df.columns:
    ...
    SPEED = 16.6  # m/s
    N = 3  #nway junction
    TRAFFIC_DENSITY = np.array([1/3,1/3,1/3])*(int(sys.argv[1])*N/3600) # density in PCU/hr/lane dvide by 3600 to get per second
