...
def main():
    ...
    sumo_cmd = ['sumo', '--duration-log.statistics', '--tripinfo-output', '/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/three_way/SUMO_CFG/my_output_file.xml', '-c', '/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/three_way/SUMO_CFG/my_confg.sumo.cfg']
...
if __name__ == "__main__":
    ...
    conflict_matrix = {}
    df = pd.read_csv("/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/three_way/conflict_matrix_3way.csv")
    for i in df.columns:
