...
Main_dir ="/home/arms04/autonomous_driving_stack/Intelligent_Intersection_management/Traditional_trafic_lights/"

for j in ["350"]:
# def func(j):
    ind_time = datetime.now(timezone("Asia/Kolkata")).strftime('%Y-%m-%d %H:%M:%S.%f')
    results_dir = '../results/unbalanced_1hour_41/{}_TTL.xml'.format(j)
